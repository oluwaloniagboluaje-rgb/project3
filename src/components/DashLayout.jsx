...
import {
  Menu, Truck, Bell, ChevronRight, Home
} from 'lucide-react';
  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--navy)', display: 'flex', flexDirection: 'column' }}>
      ...
      <header style={{
        ...
        >
          <Menu size={16} />
          <span style={{ display: 'none' }} className="show-sm">Menu</span>
        </button>
        ...
        <Link to="/" style={{ display: 'flex', alignItems: 'center', gap: 8, flexShrink: 0 }}>
          ...
          <span style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 15, letterSpacing: -.3 }}>
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <button
            ...
            style={{
              ...
              display: 'flex', cursor: 'pointer', transition: 'all .15s',
            }}
            onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--border-gold)'; e.currentTarget.style.color = 'var(--gold)'; }}
            onMouseLeave={e => { e.currentTarget.style.borderColor = 'var(--border)'; e.currentTarget.style.color = 'var(--text-2)'; }}
          >
          ...
          <button
            ...
            style={{
              ...
              background: 'var(--navy-3)', border: '1px solid var(--border)',
              color: 'var(--text)', padding: '6px 12px 6px 8px', borderRadius: 30,
          ...
          >
            <div style={{
              ...
              fontSize: 11, fontWeight: 700, color: roleColour,
            }}>
